...
public class UnlinkedAcctTest extends AbstractTestNGSpringContextTests{
	@Autowired
	private IAESCryptService aesCryptService;	
	DataBaseAccessWL dataBaseAccess = new DataBaseAccessWL();
	private static Log log = LogFactory.getLog(UnlinkedAcctTest.class);
	...
	public void unlinkedAcctTest(Map<String, String> datadriven) throws Exception{
		...
		try {
			...
			if(ret_code.equals("0000")){
				...
				//sign = GenerateSign.genSign(JSON.parseObject(reqJson1), datadriven.get("private_key"));
