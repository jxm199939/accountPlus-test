...
public class ProdTransferTest extends AbstractTestNGSpringContextTests{
	@Autowired
	...
	public void transferTest(Map<String, String> datadriven) throws Exception{
		...
		try {		
			...
			String payBillNo = json_rsp.getString("accp_txno");	
			...
			Assert.assertTrue(signAssert1&&excelResultCheck);
