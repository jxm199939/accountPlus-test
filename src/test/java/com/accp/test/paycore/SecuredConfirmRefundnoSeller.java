...
public class SecuredConfirmRefundnoSeller extends AbstractTestNGSpringContextTests {
	...
	@Test(description = "担保交易确认退款接口测试", timeOut = 600000, dataProvider = "SecuredConfirmRefundnoSeller")
	public void SecuredConfirmRefundnoSeller(Map<String, String> datadriven) throws Exception {
		...
		try {// 创单
			...
			funcUtil.writeRet2Excel(this, "SecuredConfirmRefundnoSeller",ret_code, ret_msg+accp_txno+Check);
	...
	@DataProvider(name = "SecuredConfirmRefundnoSeller")
	public Iterator<Object[]> data4SecuredConfirmRefundnoSeller() throws IOException {
		return new ExcelProvider(this, "SecuredConfirmRefundnoSeller");
	}
