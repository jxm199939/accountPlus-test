...
public class SecuredConfirmRefundwithSeller extends AbstractTestNGSpringContextTests {
	...
	@Test(description = "担保交易确认退款接口测试", timeOut = 600000, dataProvider = "SecuredConfirmRefundwithSeller")
	public void SecuredConfirmRefundwithSeller(Map<String, String> datadriven) throws Exception {
		...
		try {// 创单
			...
			// 退款
			if(!datadriven.get("refund.private_key").equals("")){
		...
		/*		Reporter.log("网关支付返回报文1111:" + datadriven.get("refund.refundMethods0"), true);
				Reporter.log("网关支付返回报文2222:" + refundMethods0, true);*/
		...
		/*		Reporter.log("网关支付返回报文1111:" + datadriven.get("refund.refundMethods0"), true);
			...
			funcUtil.writeRet2Excel(this, "SecuredConfirmRefundwithSeller",ret_code, ret_msg+accp_txno+Check);
	...
	@DataProvider(name = "SecuredConfirmRefundwithSeller")
	public Iterator<Object[]> data4SecuredConfirmRefundwithSeller() throws IOException {
		return new ExcelProvider(this, "SecuredConfirmRefundwithSeller");
	}
