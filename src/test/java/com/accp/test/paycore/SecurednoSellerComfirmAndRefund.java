...
public class SecurednoSellerComfirmAndRefund extends AbstractTestNGSpringContextTests {
	...
	@Test(description = "担保交易确认退款接口测试", timeOut = 600000, dataProvider = "SecurednoSellerComfirmAndRefund")
	public void SecurednoSellerComfirmAndRefund(Map<String, String> datadriven) throws Exception {
		...
		try {// 创单
			...
			if(!datadriven.get("securedConfirm1.private_key").equals("")){
				...
				securedConfirm3.setUser_id(MyConfig.getOidPartner(datadriven.get("securedConfirm1.user_id")));
				...
				ret_code=JSONObject.parseObject(resJson6).getString("ret_code");
				ret_msg=JSONObject.parseObject(resJson6).getString("ret_msg");
			...
			funcUtil.writeRet2Excel(this, "SecurednoSellerComfirmAndRefund",ret_code, ret_msg+accp_txno+Check);
	...
	@DataProvider(name = "SecurednoSellerComfirmAndRefund")
	public Iterator<Object[]> data4SecurednoSellerComfirmAndRefund() throws IOException {
		return new ExcelProvider(this, "SecurednoSellerComfirmAndRefund");
	}
